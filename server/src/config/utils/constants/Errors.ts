export const Errors = {
  ...
  UserNotFoundInConfirmation: 'Something went wrong with this link. Please register again!',
  TokenExpired:
  ...
  GenericErrorResetPassword: 'Oops, something went wrong. Please, try resetting your password',
  ...
  IncorrectPassword: 'The current password you provided is not correct. Please, try again',
  ...
  FileGenericError: 'Something went wrong while uploading the file. Please, try again',
