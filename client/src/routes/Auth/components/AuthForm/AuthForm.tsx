...
function AuthForm(props: IProps): JSX.Element {
  ...
  return (
    <form autoComplete="off" className={mainStyles['auth-container']} onSubmit={onSubmit}>
      <div className={mainStyles['auth-item']}>
        <InputGroup stylesContainer="auth-form">
          <Fragment>
            <InputGroup.LeftIcon icon={faEnvelope} styles={inputStyles['fa-lock-form']} />
            <InputGroup.Input
              attributes={{
                id: 'email',
                type: 'text',
      ...
      <div className={mainStyles['auth-item']}>
        <InputGroup stylesContainer="auth-form">
          {({ hidePassword, togglePasswordVisibility }) => (
            <Fragment>
              <InputGroup.LeftIcon icon={faLock} styles={inputStyles['fa-lock-form']} />
              <InputGroup.Input
                attributes={{
                  id: 'password',
                  name: 'password',
